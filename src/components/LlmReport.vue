            ...
            <el-row :gutter="24" style="font-size: 24px; color: #fff">
                <el-col :span="8">
                    <dv-border-box11 ref="dvBorder1" title="胸&#12288;痛">
                        <div class="status" :class="{ risk: item.signs.status && item.signs.status['chestPain'] != 0 }">
                ...
                <el-col :span="8">
                    <dv-border-box11 ref="dvBorder2" title="心绞痛">
                        <div class="status" :class="{ risk: item.signs.status && item.signs.status['exerciseAngina'] != 0 }">
                ...
                <el-col :span="8">
                    <dv-border-box11 ref="dvBorder3" title="心脏病">
                        <div class="status" :class="{ risk: props.item.signs.status && item.signs.status['heartDisease'] != 0 }">
        ...
        <el-carousel-item name="page2" class="container" style="height: 650px; background-image: url('/image3.png'); background-size: 100% 100%">
            <el-card body-class="page-card" id="span1" v-if="llmJson"
                ><span
                    ...
                    患者的心率处于[心率区间]。正常成年人的心率通常在60至100次/分钟之间。根据患者的心率数据，我们发现{{
                        llmJson.hrAnalyze
                    }}
            ...
            <el-card body-class="page-card" id="span2" v-if="llmJson"
                ><span
                    ...
                    患者的呼吸率在[呼吸率区间]。成人的正常呼吸率一般在12至20次/分钟之间。根据患者的呼吸率数据，我们发现{{
                        llmJson.rrAnalyze
                    }}
            ...
            <el-card body-class="page-card" id="span3" v-if="llmJson"
                ><span
                    ...
                    最新的血压测量显示收缩压为[收缩压区间] mmHg，舒张压为[舒张压区间] mmHg。成人的理想血压应维持在收缩压120
                    mmHg以下和舒张压80mmHg以下。根据患者的血压数据，我们发现{{
                        llmJson.bpAnalyze
                    }}
...
let props = defineProps(['item', 'runFlag'])
...
let history = [
    { role: 'system', content: '你是我的智能医疗助理，负责回答各项医疗问题。' },
    {
        role: 'system',
        content:
            '回答用json格式的字符串表示，且json的key用英文表示，value用中文表示，例如:"treatment": \'治疗手段\', "possible_disease": \'可能的疾病\' '
    },
